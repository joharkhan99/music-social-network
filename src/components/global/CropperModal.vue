          ...
          <div class="bg-white px-4 pt-5 pb-4 p-6">
            <div class="flex items-center">
              ...
              <div class="mt-3 text-left">
                <h3 class="text-2xl font-medium leading-4 text-gray-900">Crop Image</h3>
                ...
                <div class="pb-3 flex flex-row-reverse pt-4">
                  ...
                  <button type="button" class="inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-white text-base font-medium shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 ml-3 w-auto text-sm
                                        ">
                    Cancel
                  </button>
                </div>
...
const emit = defineEmits(["showModal", "croppedImageData"]);
